...
describe CalendarAPI do
  ...
  describe CalendarAPI do
    ...
    describe "GET /calendars" do
      ...
      let(:valid_params_2) { {"title" => "foo2", "description" => "bar2"} }
    ...
    describe "PUT /calendars/:id" do
      ...
      context "when parameters are valid" do
        ...
        it "updates the object" do
          ...
          Calendar.find(calendar.id.to_s).title.should == valid_params["title"]
          Calendar.find(calendar.id.to_s).description.should == valid_params["description"]
        end
      end
      ...
      context "when parameters are invalid" do
        ...
        context "when 'title' is blank" do
          ...
          it "doesn't update the object" do
            Calendar.find(calendar.id.to_s).title.should == origin_params["title"]
            Calendar.find(calendar.id.to_s).description.should == origin_params["description"]
          end
